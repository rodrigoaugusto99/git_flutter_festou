...
class HostFeedbackRegisterPage extends ConsumerStatefulWidget {
  ...
  ConsumerState<HostFeedbackRegisterPage> createState() =>
      _HostFeedbackRegisterPageState();
}

class _HostFeedbackRegisterPageState
    extends ConsumerState<HostFeedbackRegisterPage> {
  ...
  Widget build(BuildContext context) {
    final hostFeedbackRegisterVm =
        ref.watch(hostFeedbackRegisterVmProvider.notifier);

    final errorMessager =
        ref.watch(hostFeedbackRegisterVmProvider.notifier).errorMessage;
